...
def load_model(model_path):
    llm = LlamaCpp(model_path=f"{model_path}")
    return llm
...
if __name__ == '__main__':
    ...
    while(True):
        print("""\n\nhere is you assistant for document QA please let me know how could i help you\n",
        ...
        if query == "q":
            ...
            print("\n\n" + query, f"I think it will be{result['result']}", sep="\n")
