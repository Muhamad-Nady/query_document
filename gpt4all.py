...
class ChatWindow(QMainWindow):
    ...
    def load_model(self, temprature=0.7):
        ...
        #load the model
        llm = LlamaCpp(model_path=f"{model_path}", n_ctx=2056, f16_kv=True, logits_all=False)
        # to stop prompt processing time if true will print the time of processing the prompt
